...
const colorOptions = [
  { bg: "#000000ff", img: "sepatu/black.png", name: "black" },
  { bg: "#949eae", img: "sepatu/gray.png", name: "gray" },
  { bg: "#414eac", img: "sepatu/blue.png", name: "blue" }
];
...
const waMessages = [
  "Halo, saya ingin memesan Deviate NITRO™ 3 warna Hitam.",
  "Halo, saya ingin memesan Deviate NITRO™ 3 warna Abu-Abu.",
  "Halo, saya ingin memesan Deviate NITRO™ 3 warna Biru."
];
