...
const colorOptions = [
  { bg: "#ffffffff", img: "sepatu/white.png", name: "red" },
  { bg: "#3d3d3dff", img: "sepatu/black.png", name: "blue" },
];
...
const waMessages = [
  "Halo, saya ingin memesan Nike Air Force 1 `07 warna Putih.",
  "Halo, saya ingin memesan Nike Air Force 1 `07 warna Hitam."
];
